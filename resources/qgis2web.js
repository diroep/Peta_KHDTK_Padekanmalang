...
map.getView().fit([12685523.126096, -864003.531750, 12688055.354634, -862748.073285], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta KHDTK Padekanmalang</h2>';
        return titleElement;
    })(),
